...
//    connect( ui->horizontalSlider, SIGNAL( valueChanged( int ) ), this, SLOT( speedChanged( int ) ) );
...
// void SimplesimClient::speedChanged( int speed ){
...
void SimplesimClient::initInfoTree( const rofi::configuration::Rofibot& rofibot ){
    ...
    for( const auto& moduleInfo : rofibot.modules() ){
        ...
        if( moduleInfo.position ){
            std::string pos = "Position:\n" + IO::toString( *moduleInfo.position );
